...
<ul class="tab">
  ...
  <li><a href="javascript:void(0)" class="tablinks" onclick="openTab(event, 'Bill')">BILL</a></li>
</ul>
...
<br><button class="button" onclick="billGenerate();">Place Order</button><br><br>

<div id="Soup" class="tabcontent">
<table>
        <tr>
        <th align="center"><b>Sr. No.</b></th><th align="center"><b>Item Name</b></th><th align="center"><b>Cost</b></th><th align="center"><b>Quantity</b></th><th align="center"><b>Selection</b></th>
        </tr>
        <%
        ...
        %>
        <tr>
            <td align="center"><%= i++ %></td><td align="left"><%= rs.getString("m_name") %></td><td align="center"><%= rs.getString("m_cost") %></td><td align="center"><input type="text" id="<%= rs.getInt("m_id") %>q" name="qty"></td><td align="center"><input id="<%= rs.getInt("m_id") %>" onclick="menuSelect(this.id);" type="checkbox"></td>
        </tr>
...
<ul id="myUL">
        <%
           ...
           while(rs.next()){
        %>
        <li><a href="#"><b>Item Name:</b><%= rs.getString("m_name") %> <p class="indent"></p><b>Cost:</b><%= rs.getString("m_cost") %><p class="indent"></p><b>Quantity:</b><input class="normal" type="text" id="<%= rs.getString("m_id") %>t"><p class="indent"></p><b>Selection:</b><input type="checkbox" id="<%= rs.getString("m_id") %>s" onclick="searchMenu(this.id);"></a></li>
        <%
            }
        %>
</ul>
...
<div id="Bill" class="tabcontent">
    ...
    <br><br>
    <a href="Final_bill.jsp" class="button" target="_top">Checkout</a>
...
function billGenerate(){
    ...
    if(menuids!=""){
        if(r==true){
            jspcall= "Billing.jsp?menuids="+menuids+"&menuqtys="+menuqtys+"";
