	...
	<div id="accordian">
			...
			<div class="left" id="ordered">
				<div class="products">
					...
					<div class="product_details">
                                            <span class="product_name"><%= rs.getString("m_name") %></span>
                                            <span class="quantity"><%= rs.getString("quantity") %></span>
                                            <span class="price"><%= rs.getString("cost") %></span>
                                            <span class="price"><%= rs.getString("total") %></span>
					</div>
				...
				<div class="totals">
                                    <span class="subtitle">Subtotal <span id="sub_price"> : <%= subtotal %></span></span>
					<span class="subtitle">15% VAT <span id="sub_tax"> : <%= vat %></span></span>
				</div>
				<div class="final">
		...
		<div class="content" id="payment">
                        <div class="left credit_card">
                            <h1><input type="radio" name="payment" id="card_selection" value="Card Payment" onclick="displayCard();"><b><i>Card Payment</i></b></h1><br> 
			<form class="go-right" id="cardform" style="visibility:hidden">
            	...
            	<div class="sec_num">
              <div>
		<input type="text" name="code" value="" id="ccvcode" placeholder="123" data-trigger="change" data-validation-minlength="3" data-type="name" data-required="true" data-error-message="Enter Your Card Security Code"/>
			...
			<div class="right">
				<div class="accepted">
					<h1><input type="radio" name="payment" value="Cash" id="cash_selection" onclick="displayCard();"><b><i>Cash</i></b></h1><br>
				</div>
...
<script>
    ...
    function pay(){
        ...
        if(r==true){
            ...
            else if(document.getElementById("cash_selection").checked==false||document.getElementById("card_selection").checked==false){
